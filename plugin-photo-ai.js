module.exports = function(app, context) {
    ...
    app.post('/api/photo-ai-process', async (req, res) => {
        console.log("📥 [AI] Запрос через WARP (v1beta)...");
        try {
            ...
            // Самая стабильная ссылка для работы с изображениями
            const apiUrl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key=" + API_KEY;
            
            // Динамически подгружаем всё необходимое внутри функции
            ...
            if (data.candidates && data.candidates[0].content) {
                ...
                // Убираем возможные метки Markdown от нейросети
    ...
    console.log("✅ МОДУЛЬ PHOTO-AI ПОДКЛЮЧЕН И РАБОТАЕТ ЧЕРЕЗ WARP");
};
