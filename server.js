...
const oauth2Client = new google.auth.OAuth2('355201275272-14gol1u31gr3qlan5236v241jbe13r0a.apps.googleusercontent.com', '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');
...
// Новый роут специально для Мерчендайзера
...
bot.on('text', async (ctx) => {
    ...
    if (idx !== -1) { 
        ...
        ctx.reply('✅ Ключ привязан!', { reply_markup: { inline_keyboard: [[{ text: "📊 КАБИНЕТ", web_app: { url: SERVER_URL + "/client-dashboard?chatId=" + ctx.chat.id } }]] } });
