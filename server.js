...
app.post('/upload', async (req, res) => {
    ...
    try {
        ...
        console.log(`✅ УСПЕШНО! ${addr}${entrance} сохранен для ${cName}`);
...
app.listen(process.env.PORT || 3000, () => console.log("СИСТЕМА ОТЧЕТОВ РАБОТАЕТ"));
