...
/**
 * ============================================================================
 * TITANIUM ADAPTIVE v39.0 | FULL MOBILE & DESKTOP EDITION
 * ----------------------------------------------------------------------------
 * АВТОР: GEMINI AI (2026)
 * ПРАВООБЛАДАТЕЛЬ: Никитин Евгений Анатольевич
 * ИНСТРУКЦИЯ: Скопируйте этот код целиком, заменив всё содержимое файла.
 * ============================================================================
 */
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; outline: none; }
        ...
        .logo i { color: var(--blue); font-size: 26px; }
        ...
        .breadcrumbs { height: 50px; display: flex; align-items: center; font-size: 18px; font-family: 'Google Sans'; color: var(--gray); overflow: hidden; white-space: nowrap; }

        .file-table { width: 100%; border-collapse: collapse; }
        .file-table th { text-align: left; padding: 12px 8px; font-size: 13px; color: var(--gray); border-bottom: 1px solid var(--border); position: sticky; top: 0; background: #fff; }
        ...
        @media (max-width: 768px) {
            ...
            .overlay { display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.4); z-index: 1400; }
        ...
        /* PREVIEW MODAL */
        #pv-modal { display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: #000; z-index: 9999; flex-direction: column; }
        ...
        #toast { position: fixed; bottom: 100px; left: 50%; transform: translateX(-50%); background: #323232; color: #fff; padding: 10px 20px; border-radius: 20px; font-size: 14px; display: none; z-index: 10000; }
    </style>
</head>
<body>
...
<div class="wrapper">
    <aside id="sidebar">
        ...
        <div class="nav-link"><i class="fa fa-star"></i> Помеченные</div>
        <div class="nav-link"><i class="fa fa-trash-can"></i> Корзина</div>
        <div style="margin-top: auto; padding: 20px; font-size: 11px; color: #bbb;">TITANIUM v39.0 FULL ADAPTIVE</div>
    </aside>
    ...
    <main>
        ...
        <table class="file-table">
            <thead>
                <tr>
                    <th>Название</th>
                    <th class="hide-mobile" style="width: 200px;">Изменено</th>
                    <th class="hide-mobile" style="width: 100px;">Размер</th>
                </tr>
            </thead>
...
<script>
    ...
    console.log("✅ TITANIUM ADAPTIVE v39.0 FULLY LOADED");
};
